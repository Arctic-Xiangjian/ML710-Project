...
run = wandb.init(project='ml710_project', entity='arcticfox', name='vit_model_parallel_3gpu'+'_'+'_'+datetime.now().strftime('%Y%m%d_%H%M%S'), job_type="training",reinit=True)
