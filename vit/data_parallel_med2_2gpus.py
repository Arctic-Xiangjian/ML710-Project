...
run = wandb.init(project='ml710_project', entity='arcticfox', name='data_pytorch2_2gpu'+'_'+'vit'+'_'+datetime.now().strftime('%Y%m%d_%H%M%S'), job_type="training",reinit=True)
