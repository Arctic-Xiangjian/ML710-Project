...
run = wandb.init(project='ml710_project', entity='arcticfox', name='data_ours_2gpu'+'_'+'vit'+'_'+datetime.now().strftime('%Y%m%d_%H%M%S'), job_type="training",reinit=True)
...
train([model_1, model_2], train_dataloader, optimizers, criterion, EPOCHS, GPU_IDS)